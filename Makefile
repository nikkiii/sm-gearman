...
OBJECTS = sdk/smsdk_ext.cpp extension.cpp worker.cpp
...
INCLUDE += -I. -I.. -Isdk -I$(SMSDK)/public -I$(SMSDK)/public/sourcepawn -I$(MMSOURCE19)/core/sourcehook -I/usr/include/libgearman1.0
...
LINK += -m32 -lm -ldl lib/libgearman.a
